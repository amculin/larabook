...
<div class="container-xl">
    <div class="page-header d-print-none">
        <div class="row g-2 align-items-center">
            <div class="col">
                <h2 class="page-title">Create Publisher</h2>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('publishers.store') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input type="text" maxlength="40" id="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autofocus />
